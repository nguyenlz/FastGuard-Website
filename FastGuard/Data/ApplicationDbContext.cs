...
namespace FastGuard.Data
{
    public partial class ApplicationDbContext : IdentityDbContext<ApplicationUser>
	{
        ...
        public List<object> GetRevenue()
        {
            ...
            string connectionString = "Server=MYSQL5045.site4now.net;Database=db_aa3558_login;Uid=aa3558_login;Pwd=lazeel02";
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
				optionsBuilder.UseMySql("Server=MYSQL5045.site4now.net;Database=db_aa3558_login;Uid=aa3558_login;Pwd=lazeel02", Microsoft.EntityFrameworkCore.ServerVersion.Parse("10.4.28-mariadb"));
			}
		}
